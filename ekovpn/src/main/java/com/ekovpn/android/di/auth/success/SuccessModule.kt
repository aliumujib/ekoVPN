 ...
 */
package com.ekovpn.android.di.auth.success
...
/**
 * Class that contributes to the object graph [SuccessModule].
 *
 * @see Module
 */
@ExperimentalCoroutinesApi
@Module
class SuccessModule(@VisibleForTesting(otherwise = PRIVATE) val fragment: SuccessFragment) {
