...
import com.ekovpn.wireguard.configstore.FileConfigStore
import com.ekovpn.wireguard.repo.TunnelManager
import com.ekovpn.wireguard.utils.AsyncWorker
...
object WireGuardInitializer {
    ...
    fun onCreate(applicationContext: Context) {
        ...
        tunnelManager = TunnelManager(FileConfigStore(applicationContext), applicationContext)
