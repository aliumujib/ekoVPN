...
class QuickTileService : TileService() {
    ...
    override fun onCreate() {
        ...
        val icon = SlashDrawable(resources.getDrawable(R.drawable.ic_tile, WireGuardInitializer.get().theme))
    ...
    override fun onStartListening() {
        WireGuardInitializer.getTunnelManager().addOnPropertyChangedCallback(onTunnelChangedCallback)
    ...
    override fun onStopListening() {
        ...
        WireGuardInitializer.getTunnelManager().removeOnPropertyChangedCallback(onTunnelChangedCallback)
    }

    private fun updateTile() {
        // Update the tunnel.
        val newTunnel = WireGuardInitializer.getTunnelManager().lastUsedTunnel
        if (newTunnel != tunnel) {
            if (tunnel != null) tunnel!!.removeOnPropertyChangedCallback(onStateChangedCallback)
            tunnel = newTunnel
            if (tunnel != null) tunnel!!.addOnPropertyChangedCallback(onStateChangedCallback)
